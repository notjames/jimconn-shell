...
complete -c git-format-patch -l indent-heuristic -l no-indent-heuristic -l compaction-heuristic -l no-compaction-heuristic --description 'These are to help debugging and tuning experimental heuristics (which are off…'
