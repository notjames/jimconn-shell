...
complete -c youtube-dl -l fragment-retries --description 'Number of retries for a fragment (default is 10), or "infinite" (DASH and hls…'
complete -c youtube-dl -l skip-unavailable-fragments --description 'Skip unavailable fragments (DASH and hlsnative only) . RS . RE.'
