...
complete -c docker-run -l detach-keys --description '   Override the key sequence for detaching a container.'
...
complete -c docker-run -l init-path --description '   Path to the docker-init binary.'
...
complete -c docker-run -l ipc --description '   Default is to create a private IPC namespace (POSIX SysV IPC) for the cont…'
complete -c docker-run -l isolation --description '   Isolation specifies the type of isolation technology used by containers.'
complete -c docker-run -s l -l label --description '   Set metadata on the container (e. g. , --label com. example. key=value).'
complete -c docker-run -l kernel-memory --description '   Kernel memory limit (format: <number>[<unit>], where unit = b, k, m or g) …'
complete -c docker-run -l label-file --description '   Read in a line delimited file of labels.'
complete -c docker-run -l link --description '   Add link to another container in the form of <name or id>:alias or just <n…'
...
complete -c docker-run -s m -l memory --description '   Memory limit (format: <number>[<unit>], where unit = b, k, m or g) Allows …'
complete -c docker-run -l memory-reservation --description '   Memory soft limit (format: <number>[<unit>], where unit = b, k, m or g) Af…'
complete -c docker-run -l memory-swap --description '   A limit value equal to memory plus swap.'
...
complete -c docker-run -l network --description '   Set the Network mode for the container                                \'bri…'
...
complete -c docker-run -l pids-limit --description '   Tune the container\'s pids limit.'
complete -c docker-run -l uts --description '   Set the UTS mode for the container      host: use the host\'s UTS namespace…'
complete -c docker-run -l privileged --description '   Give extended privileges to this container.  The default is false.'
complete -c docker-run -l read-only --description '   Mount the container\'s root filesystem as read only.'
complete -c docker-run -l restart --description '   Restart policy to apply when a container exits (no, on-failure[:max-retry]…'
complete -c docker-run -l rm --description '   Automatically remove the container when it exits.  The default is false.'
complete -c docker-run -l security-opt --description '   Security Options "label=user:USER"   : Set the label user for the containe…'
...
complete -c docker-run -l volumes-from --description 'You can add :ro or :rw suffix to a volume to mount it  read-only or read-writ…'
