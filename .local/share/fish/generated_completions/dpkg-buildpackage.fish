...
complete -c dpkg-buildpackage -o uc -l unsigned-changes --description 'Do not sign the . changes file (long option since dpkg 1. 18. 8).'
...
complete -c dpkg-buildpackage -s T -l rules-target --description 'Calls debian/rules target after having setup the build environment and stops …'
