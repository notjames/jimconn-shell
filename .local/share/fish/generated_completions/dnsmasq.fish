...
complete -c dnsmasq -l 'mx-host.' --description 'returns a MX record containing the MX target for MX queries on the  hostname …'
complete -c dnsmasq -l 'domain.' --description 'The default for the target domain is empty, and the default for port is one a…'
complete -c dnsmasq -l 'cname.' --description 'If the target does not satisfy this criteria, the whole cname is ignored.'
complete -c dnsmasq -l 'trust-anchor.' --description 'Because the DNSSEC validation process uses the cache, it is not permitted to …'
complete -c dnsmasq -l 'query-port.' --description '.'
complete -c dnsmasq -l dhcp-option: --description '.'
complete -c dnsmasq -l 'dhcp-script.' --description 'It gets two arguments, firstly the action, which is a string containing, "add…'
...
complete -c dnsmasq -l 'hostsdir.' --description 'The dhcp lease change script is called for all existing DHCP leases.  If .'
complete -c dnsmasq -l 'host-record.' --description 'auth-server=our. zone. com,eth0 host-record=our. zone. com,1. 2. 3.'
