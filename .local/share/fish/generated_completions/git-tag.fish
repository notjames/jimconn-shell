...
complete -c git-tag -s l -l list --description 'List tags with names that match the given pattern (or all if no pattern is gi…'
...
complete -c git-tag -l merged --description 'Only list tags whose tips are reachable, or not reachable if --no-merged is u…'
